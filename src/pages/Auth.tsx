      ...
      >
        ...
        <div className="card-elevated p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-card border border-border rounded-xl text-foreground font-medium hover:bg-secondary/50 transition-all duration-200"
          >
